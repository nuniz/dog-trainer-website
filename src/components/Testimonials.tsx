  ...
  const testimonials = [
    {
      ...
      dogName: 'פאדג',
      rating: 5,
      text: 'אימצנו את פאדג כשהייתה בת שנתיים, אחרי שנמצאה ברחוב. היא סבלה מחרדת נטישה ומשכה המון ברצועה, מה שהקשה עלינו מאוד. אסף עזר לנו להתגבר על קשיים אלו, וכיום פאדג רגועה, ואנחנו אפילו מתחילים אילוף מתקדם.',
